      ...
      <table>
        ...
        <tbody>
          <tr v-for="b in bookings" :key="b._id">
            <td class="mono">{{ b._id.$oid?.slice(-8) }}</td>
...
.log-item { padding: 12px; border-radius: 8px; margin-bottom: 8px; }
.log-item.success { background: #f0fdf4; border-left: 3px solid #22c55e; }
.log-item.warning { background: #fffbeb; border-left: 3px solid #f59e0b; }
...
.log-data { font-size: 11px; color: #6b7280; margin: 4px 0 0; }
</style>